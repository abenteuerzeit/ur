...
public class MenuDisplay(IConsoleWrapper console, IBoardRendererFactory rendererFactory)
{
    ...
    private readonly string[] _options = ["Play Game", "View Board"];
    ...
    private void HandleSelection(int selectedIndex)
    {
        switch (selectedIndex)
        {
            case 0: // Play Game
                ...
                break;
            case 1: // View Board
                DisplayBoard(BoardOrientation.HorizontalLtr);
                break;
        }
    }
    ...
    {
        _rendererFactory.CreateRenderer(BoardOrientation.HorizontalLtr);
        var gameController = new GameController(_console, _rendererFactory);
